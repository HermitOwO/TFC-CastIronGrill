...
val modId: String = "castirongrill"
...
base {
    archivesName.set("CastIronGrill-NeoForge-$minecraftVersion")
...
dependencies {
    ...
    // Firmalife 3.0.0
    implementation(group = "curse.maven", name = "firmalife-453394", version = "7442721")
